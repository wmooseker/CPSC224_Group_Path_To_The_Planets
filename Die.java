...
public class Die {
	...
	/**
	 * Die constructor stores an integer value and a variable rand to generate
	 * random numbers Die is used and called by Yahtzee
	 */
	public Die() {
		Planet planet;
		rand = new Random();
	...
	/**
	 * "Rolls the die" or assigns a random integer between 1 and 6 to the die's
	 * value
	 */

...
public class ScorecardFrame extends JFrame implements ActionListener {
	...
	private JPanel createCardPanel(int[] upperCardScores, int smallStraight, int largeStraight, int triForce,
			int totalScore) {
		...
		// Graphics g;
		// paint(g); //************************************I know I need this,
		// but idk how to initialize it.... Kate?
		...
		String[] columnNames = { "What is being Scored", "Points Scored" };

		Object[][] scores = { { "Mercury", stringScores[0], }, { "Venus", stringScores[1], },
				{ "Mars", stringScores[2], }, { "Jupiter", stringScores[3], }, { "Saturn", stringScores[4], },
				{ "Uranus", stringScores[5], }, { "Neptune", stringScores[6], },
				{ "Small Straight", String.valueOf(smallStraight), },
				{ "Large Straight", String.valueOf(largeStraight), }, { "Tri Force", String.valueOf(triForce), },

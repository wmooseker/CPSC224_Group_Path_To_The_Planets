...
public class RulesFrame extends JFrame implements ActionListener {
	...
	private JPanel createFirstRulesPanel() {
		...
		JLabel description2 = new JLabel(
				"<html>All players start on Earth and try to get to every planet in our solar system by rolling die </html>");
	...
	private JPanel createSecondRulesPanel() {
		...
		JLabel description = new JLabel(
				"<html>Each player rolls seven 7-sided die. Each die represents a planet. Each side of each die correlates with a certain planet.</html>");
		description.setFont(new Font("Verdana", 1, 18));
		description.setForeground(Color.white);
		rulesPanel1.add(description);

		JLabel description2 = new JLabel(
				"<html>To reach a planet, you must roll that planet with that planet’s die </html>");
		...
		JLabel description3 = new JLabel(
				"<html>So rolling Mercury on any other die besides the Mercury die would not earn any points. </html>");
	...
	private JPanel createThirdRulesPanel() {
		...
		JLabel description = new JLabel(
				"<html>• The order of each turn is randomized each time in order to prevent any unfair advantage.</html>");
		description.setFont(new Font("Verdana", 1, 18));
		description.setForeground(Color.white);
		rulesPanel2.add(description);

		JLabel description2 = new JLabel(
				"<html>• Each player rolls every die each turn, unless they have already reached that die’s planet.</html>");
		description2.setFont(new Font("Verdana", 1, 18));
		description2.setForeground(Color.white);
		rulesPanel2.add(description2);

		JLabel description3 = new JLabel(
				"<html>• The first player to reach every planet wins, but each player only has 8 turns to do so.</html>");
		description3.setFont(new Font("Verdana", 1, 18));
		description3.setForeground(Color.white);
		rulesPanel2.add(description3);

		JLabel description4 = new JLabel(
				"<html>• The game is over when a player visits all seven planets, or when every player is out of turns.</html>");
		description4.setFont(new Font("Verdana", 1, 18));
		description4.setForeground(Color.white);
		rulesPanel2.add(description4);

		JLabel description5 = new JLabel(
				"<html>• There can be a maximum of seven total players and a minimum of one player.</html>");
	...
	private JPanel createFourthRulesPanel() {
		...
		JLabel description = new JLabel(
				"<html>Each planet earns a player points based on its position in the solar system.</html>");
		description.setFont(new Font("Verdana", 1, 18));
		description.setForeground(Color.white);
		rulesPanel3.add(description);

		JLabel description2 = new JLabel(
				"<html>If a player is the first in that game to visit a planet, they earn bonus points.</html>");
		description2.setFont(new Font("Verdana", 1, 18));
		description2.setForeground(Color.white);
		...
		JLabel list4 = new JLabel(
				"• Visiting Jupiter earns a player 4 points, visiting it first is an extra 10 points");
		list4.setFont(new Font("Verdana", 1, 18));
		list4.setForeground(Color.white);
		rulesPanel3.add(list4);

		JLabel list5 = new JLabel(
				"• Visiting Saturn earns a player 5 points, visiting it first is an extra 11 points");
		list5.setFont(new Font("Verdana", 1, 18));
		list5.setForeground(Color.white);
		rulesPanel3.add(list5);

		JLabel list6 = new JLabel(
				"• Visiting Uranus earns a player 6 points, visiting it first is an extra 12 points");
		list6.setFont(new Font("Verdana", 1, 18));
		list6.setForeground(Color.white);
		rulesPanel3.add(list6);

		JLabel list7 = new JLabel(
				"• Visiting Neptune earns a player 7 points, visiting it first is an extra 13 points");
		list7.setFont(new Font("Verdana", 1, 18));
		list7.setForeground(Color.white);
	...
	private JPanel createFifthRulesPanel() {
		...
		JLabel description = new JLabel(
				"<html>• Visiting all seven planets in one turn results in an automatic win of the game.</html>");
		description.setFont(new Font("Verdana", 1, 20));
		description.setForeground(Color.white);
		rulesPanel4.add(description);

		JLabel description2 = new JLabel(
				"<html>•If you visit exactly 3 planets in a turn, it is a Tri-Force into a super nebula. You earn 33 points.</html>");
		description2.setFont(new Font("Verdana", 1, 20));
		description2.setForeground(Color.white);
		rulesPanel4.add(description2);

		JLabel description3 = new JLabel(
				"<html>•If you visit 2 adjacent planets in a turn, it is a small straight. You earn 30 points.</html>");
		description3.setFont(new Font("Verdana", 1, 20));
		description3.setForeground(Color.white);
		rulesPanel4.add(description3);

		JLabel description4 = new JLabel(
				"<html>•If you visit 3 adjacent planets in a turn, it is a large straight. You earn 50 points.</html>");
		description4.setFont(new Font("Verdana", 1, 20));
		description4.setForeground(Color.white);
		rulesPanel4.add(description4);

		JLabel description5 = new JLabel(
				"<html>•If you run out of turns without making it to a single planet, you earn the NASA award. If you earn the NASA award, you automatically win.</html>");

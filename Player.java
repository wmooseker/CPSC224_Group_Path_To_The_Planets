...
public class Player {
	...
	private void displayHand(Player player) {
		...
		// We can get rid of this function and call a DisplayRoll panel which
		// shows 7 dice with the planet rolled on each
	...
	public void finalScore(Player player) {
		// No GUI needed for this function, it will be called in the
		// displayScorecard function in Scorecard class

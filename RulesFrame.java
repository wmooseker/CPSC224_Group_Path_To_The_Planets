...
public class RulesFrame extends JFrame implements ActionListener{
    ...
    private JPanel createRulesPanel() {
        ...
        rulesTitle.setFont(new Font("Verdana",1,65));
    ...
    private JPanel createFirstRulesPanel() {
        ...
        howToWin.setFont(new Font("Verdana",1,40));
        ...
        howToPlay.setFont(new Font("Verdana",1,40));
    ...
    private JPanel createSecondRulesPanel() {
    	...
    	JLabel howToWin = new JLabel("(Continued)");
        howToWin.setFont(new Font("Verdana",1,25));
        howToWin.setForeground(Color.white);
        ...
        description.setFont(new Font("Verdana",1,10));
        description.setForeground(Color.white);
        rulesPanel1.add(howToWin);
        ...
        list2.setFont(new Font("Verdana",1,10));
        ...
        list3.setFont(new Font("Verdana",1,10));
        ...
        list4.setFont(new Font("Verdana",1,10));
        ...
        list5.setFont(new Font("Verdana",1,10));
        ...
        list6.setFont(new Font("Verdana",1,10));
        ...
        list7.setFont(new Font("Verdana",1,10));
        ...
        description3.setFont(new Font("Verdana",1,10));
        description3.setForeground(Color.white);
        rulesPanel1.add(description3);
        
        rulesPanel1.setLayout(new GridLayout(24,1));
    ...
    private JPanel createThirdRulesPanel() {
        ...
        description4.setFont(new Font("Verdana",1,10));
        ...
        description5.setFont(new Font("Verdana",1,10));
    ...
    private JPanel createFourthRulesPanel() {
    	...
    	JLabel howToWin = new JLabel("Scoring:");
        howToWin.setFont(new Font("Verdana",1,25));
        howToWin.setForeground(Color.white);
        rulesPanel3.add(howToWin);
        ...
        list.setFont(new Font("Verdana",1,10));
    ...
    private JPanel createFifthRulesPanel() {
    	...
    	JLabel scoring = new JLabel("Special Bonuses:");
        scoring.setFont(new Font("Verdana",1,40));
        scoring.setForeground(Color.white);
        rulesPanel4.add(scoring);
